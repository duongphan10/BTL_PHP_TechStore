                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="product-price" id="price-preview">
                            <span>Giá: <?php echo number_format($product['price']); ?>đ</span>
                        </div>


                        <!-- action="https://growmax.myharavan.com/cart/add" -->
                        <form id="add-item-form" action="them-vao-gio-hang/<?php echo $product['id']; ?>" method="post" class="variants clearfix">
                                    ...
                                    <div class="col-lg-5 col-md-12 col-sm-6 col-xs-12">
                                        ...
                                        <div class="quantity-box clearfix">
                                            <div class="quantity-bgr">
                                                <input type="number" id="quantity" name="quantity" value="1" min="1" max="<?php echo number_format($product['quantity']); ?>" class="quantity-selector" 
                                                    oninvalid="this.setCustomValidity('Số lượng không được vượt quá <?php echo number_format($product['quantity']); ?>')" oninput="this.setCustomValidity('')">

                                            </div>
                                        </div>
                                        <b> Sản phẩm có sẵn: <?php echo number_format($product['quantity']); ?></b>
                                    </div>
