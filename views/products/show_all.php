                                    ...
                                    <div class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 wow fadeInUp animation rainbow_0">
                                        <div class="product-item product-resize clearfix">
                                                ...
                                                <div class="hover-mask">
                                                    <div class="inner-mask">
                                                        ...
                                                        <ul class="add-to-links">
                                                            <li><a href="<?php echo $product_link; ?>" class="mask-view" data-handle="/products/xa-lach-romaine-dl" title="Xem chi tiết"><i class="fa fa-eye"></i></a></li>
                                            ...
                                            <div class="right-block product-detail">
                                                ...
                                                <p class="pro-vendor">
                                                    Hãng sản xuất: <span><?php echo  $product['supplier']; ?></span>
                                                </p>
            ...
            <form action="" method="post" <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-left">
                ...
                <div class="sidebar_price list-group">
                    ...
                    <ul class="nav navs sidebar menu" id='cssmenu'>
                        ...
                        <li class="item  first">
                            <a>
                                <input type="checkbox" name="price[]" value="1" <?php echo $checked_price1; ?>> Dưới 1,000,000
                            </a>
                        </li>
                        <li class="item">
                            <a>
                                <input type="checkbox" name="price[]" value="2" <?php echo $checked_price2; ?>> 1,000,000 - 3,000,000
                            </a>
                        </li>
                        <li class="item">
                            <a>
                                <input type="checkbox" name="price[]" value="3" <?php echo $checked_price3; ?>> 3,000,000 - 6,000,000
                            </a>
                        </li>
                        <li class="item ">
                            <a>
                                <input type="checkbox" name="price[]" value="4" <?php echo $checked_price4; ?>> 6,000,000 - 10,000,000
                            </a>
                        </li>
                        <li class="item  last">
                            <a>
