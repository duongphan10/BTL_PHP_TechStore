                ...
                foreach ($_POST['price'] as $price) {
                    switch ($price) {
                        case 1:
                            ...
                            break;
                        case 2:
                            $str_price .= " OR products.price BETWEEN 1000000 AND 3000000";
                            break;
                        case 3:
                            $str_price .= " OR products.price BETWEEN 3000000 AND 6000000";
                            break;
                        case 4:
                            $str_price .= " OR products.price BETWEEN 6000000 AND 10000000";
                            break;
                        case 5:
